...
<head>
  <meta charset="UTF-8" />
  <title>Manage Users | iFound</title>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2 text-primary"><i class="fas fa-users me-2"></i>Manage Users</h1>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="fas fa-list me-2"></i>Manage Users</h5>
              </div>
              <div class="card-body">
...
<!--                              <a href="${pageContext.request.contextPath}/users/edit?id=${u.id}" class="btn btn-primary">
