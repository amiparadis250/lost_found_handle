...
<head>
  <meta charset="UTF-8" />
  <title>Report Lost Items | iFound</title>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2 text-danger"><i class="fas fa-search-minus me-2"></i>Report Lost Items</h1>
        ...
        <div class="row mb-4">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form action="${pageContext.request.contextPath}/lost/search" method="get" class="row g-3">
                  <div class="col-md-4">
        ...
        <div class="d-flex justify-content-end mb-4">
          <a href="${pageContext.request.contextPath}/lost/new" class="btn btn-danger">
          ...
          <c:forEach var="item" items="${lostItems}">
            <div class="col-md-6 col-lg-4 item-card">
              <div class="card h-100">
                <span class="badge bg-danger item-badge">Lost</span>
                <c:choose>
                ...
                <div class="card-footer bg-white border-top-0">
                  <a href="${pageContext.request.contextPath}/lost/details?id=${item.id}" class="btn btn-outline-primary btn-sm w-100">
                    <i class="fas fa-info-circle me-1"></i>View Details
                  </a>
<!--                  <a href="${pageContext.request.contextPath}/lost/edit?id=${item.id}" class="btn btn-outline-secondary btn-sm w-100 mt-2">
          ...
          <c:if test="${empty lostItems}">
            <div class="col-12 text-center py-5">
              ...
              <p class="text-muted">No items have been reported lost yet.</p>
              <a href="${pageContext.request.contextPath}/lost/new" class="btn btn-primary mt-3">
        ...
        <a href="${pageContext.request.contextPath}/lost/new" class="btn btn-danger btn-float d-md-none">
