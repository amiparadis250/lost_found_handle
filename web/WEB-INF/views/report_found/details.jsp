...
<head>
  <meta charset="UTF-8" />
  <title>Found Item Details | iFound</title>
...
<body>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2 text-success"><i class="fas fa-info-circle me-2"></i>Found Item Details</h1>
            ...
            <div class="card form-card mb-4">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <p class="form-control-static">${foundItem.title}</p>
                </div>

                <div class="mb-3">
                  <label class="form-label">Description</label>
                  <p class="form-control-static">${foundItem.description}</p>
                </div>

                <div class="mb-3">
                  <label class="form-label">Location</label>
                  <p class="form-control-static">${foundItem.location}</p>
                </div>

                <div class="mb-3">
                  <label class="form-label">Photo</label>
                  <c:choose>
                    <c:when test="${not empty foundItem.photo}">
                      <img src="${foundItem.photo}" class="img-fluid" alt="${foundItem.title}" style="max-height: 200px;">
                    </c:when>
                    <c:otherwise>
                ...
                <div class="mb-3">
                  ...
                  <p class="form-control-static">${foundItem.createdAt}</p>
                </div>
  ...
  <script>
    function initMap() {
      const latitude = ${foundItem.latitude};
      const longitude = ${foundItem.longitude};
      ...
      // Prevent default behavior for map interactions
