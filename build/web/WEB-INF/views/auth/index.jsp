<%-- 
    Document   : index
    Created on : May 19, 2025, 6:53:27 AM
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/login" id="login-btn">Login</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="hero-section parallax">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1 class="display-4 fw-bold mb-4">Reunite with Your Lost Items</h1>
                    <p class="lead mb-4">iFound is a smart lost & found platform that connects people who have lost items with those who have found them, through a simple and secure process.</p>
