...
<head>
  <meta charset="UTF-8" />
  <title>Report Found Item | iFound</title>
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2 text-success"><i class="fas fa-search-plus me-2"></i>Report Found Item</h1>
          ...
          <div class="col-lg-8">
            <div class="card form-card mb-4">
              <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="fas fa-clipboard-list me-2"></i>Found Item Details</h5>
              </div>
              <div class="card-body">
                <form action="${pageContext.request.contextPath}/found/add" method="post" id="foundItemForm">
                  <div class="mb-3">
                  ...
                  <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    <a href="${pageContext.request.contextPath}/report/found" class="btn btn-outline-secondary me-md-2">
    ...
    if (locations.length > 0) {
      locations.forEach(location => {
        const $item = $('<div>')
          ...
          .html('<i class="fas fa-map-marker-alt me-2 text-success"></i>' + location.name)
          .hover(function() {
